...
public class JavaCraft {
  ...
  public static void startGame() {
    ...
    while (true) {
      ...
      System.out.println(ANSI_CYAN
          + "Enter your action: 'WASD': Move, 'M': Mine, 'P': Place, 'C': Craft, 'I': Interact, 'Save': Save, 'Load': Load, 'Exit': Quit, 'Unlock': Unlock Secret Door, 'Chat': Chat"
          + ANSI_RESET);
  ...
  public static void displayLegend() {
    ...
    System.out.println(ANSI_WHITE + "\u25CF\u25CF - Sphere");
    System.out.println(ANSI_ACE + "\u2660\u2660 - Ace");
